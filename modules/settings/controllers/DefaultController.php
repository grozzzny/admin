...
namespace grozzzny\admin\modules\settings\controllers;

use Yii;
use grozzzny\admin\modules\settings\models\AdminSettings;
use grozzzny\admin\modules\settings\models\AdminSettingsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for AdminSettings model.
 */
