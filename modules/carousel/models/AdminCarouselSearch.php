...
/**
 * AdminCarouselSearch represents the model behind the search form of `grozzzny\admin\modules\carousel\models\AdminCarousel`.
 */
class AdminCarouselSearch extends AdminCarousel
{
    /**
     * {@inheritdoc}
     */
